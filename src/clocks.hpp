...
struct GPIOClockControl {
    enum : u32 {
        AUXSRC = 0b0000'0000'0000'0000'0000'0001'1110'0000,
...
struct GPIOClockDiv {
    enum : u32 {
        FRAC = 0b0000'0000'0000'0000'0000'0000'1111'1111,
        INT  = 0b1111'1111'1111'1111'1111'1111'0000'0000,
    };
};
...
struct RefClockControl {
    enum : u32 {
        SRC    = 0b0000'0000'0000'0000'0000'0000'0000'0011,
        AUXSRC = 0b0000'0000'0000'0000'0000'0000'0110'0000,
    };
};

struct RefClockDiv {
    enum : u32 {
        INT = 0b0000'0000'0000'0000'0000'0011'0000'0000,
    };
};
...
struct SysClockControl {
    enum : u32 {
        SRC    = 0b0000'0000'0000'0000'0000'0000'0000'0001,
        AUXSRC = 0b0000'0000'0000'0000'0000'0000'1110'0000,
    };
};
...
struct ResusControl {
    enum : u32 {
        ...
        FRCE    = 0b0000'0000'0000'0000'0001'0000'0000'0000,
...
struct FC0Result {
    enum : u32 {
        FRAC = 0b0000'0000'0000'0000'0000'0000'0000'1111,
